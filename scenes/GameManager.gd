...
"end": "PARTIDA ACABADA, COMIENZA EL RECUENTO"}
...
func get_bonuses_winners():	
	...
	print("el jugador con la palabra mas larga es: ", longest_bonus_winner)
	
	print("el jugador con mas palabras formadas es: ", max_words_bonus_winner)
